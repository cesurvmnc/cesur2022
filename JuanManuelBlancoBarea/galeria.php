...
<body>
  ...
  <h2>Esto lo ha hecho Juan Manuel Blanco Barea</h2>
  <p>Espero que esto este bien y le sea leve la correccion</p>
  <h1>FELICES FIESTAS Y PROSPERO AÑO NUEVO</h1>
  ...
  <p>Copyright 2022, www.cesurformaion.com</p>
    ...
    <h1 style="color:red">
    <?php
    echo 'Autor:Juan Manuel Blanco Barea';
    ?>
    </h1>
